       ...
       $(document).ready(function(){
           $("#search").keyup(function(){
               ...
               if(str == "") {
                   ...
                   $.get( "{{ url('admin/search-user?search=') }}"+str, function( data ) {
                       alert(data);
                   });
               }
           });
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">List User
                <a class="btn btn-primary" href="{{route('add-user')}}" style="margin-left: 90%">
                    <span class="glyphicon glyphicon-plus"></span>
                </a>
                <form class="form-horizontal" role="form" method="POST" action="{{ route('search-user')}}">
                    {{ csrf_field() }}
                    <br>
                    <div class="row">
            ...
            <div class="panel-body">
                @if(count($user_list)<=0)
                    <h3 align="center"> No have any user !!</h3>
                @endif
