...
@section('title') Add Admin User @endsection
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register-admin') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('block_no') ? ' has-error' : '' }}">
                            <label for="block_no" class="col-md-4 control-label">Block No.</label>
                            <div class="col-md-6">
                                <select id="block_no" class="form-control" name="block_no" required autofocus>
